...
switch (kverfilter) {
  ...
  case 'lts-head':
    ...
    lts_kversions.add(kversionFactory.factory("v6.6"))  // LTS until December 2027
    lts_kversions.add(kversionFactory.factory("v6.12")) // LTS until December 2028
    lts_kversions.add(kversionFactory.factory("v6.18")) // LTS until December 2028
